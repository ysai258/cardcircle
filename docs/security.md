...
The catalogue's own 294 URLs came from each issuer's sitemap or card-listing
...
| `tests/unit/bank-links` | 25 | Host allowlist, look-alike hosts, link fallback, per-bank link coverage |
